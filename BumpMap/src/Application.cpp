...
void Application::initTexture()
{
	...
	unsigned char *image_data = SOIL_load_image("bump.jpg", &x, &y, &n, 0);
	//GLuint tex = 0;
...
void Application::initSecondTexture()
{
	...
	int x, y, n;
	//int force_channels = 4;
	unsigned char *image_data = SOIL_load_image("textura.jpg", &x, &y, &n, 0);
	//GLuint tex = 0;
...
void Application::setup()
{
	...
	ulightPos[0] = glGetUniformLocation(plane.shader, "LightPos");
...
void Application::display()
{
	...
	perspective = glm::perspective(80.0f/180.0f*3.1416f,(float)w/h, 0.1f, 200.0f);

	Transform = perspective*lookAt*rotationY;
